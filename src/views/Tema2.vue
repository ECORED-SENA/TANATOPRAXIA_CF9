...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .bloque-texto-a.bg--greenGray.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between     
        .col-lg-4.mb-4.mb-lg-0(data-aos="zoom-in")         
          img(src="@/assets/curso/tema_2/img_2_01.svg", alt="alt").m-auto.img--500
    ...
    .bloque-texto-a.bg--greenGray.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between     
        .col-lg-4.mb-4.mb-lg-0(data-aos="zoom-in")         
          img(src="@/assets/curso/tema_2/img_2_04.svg", alt="alt").m-auto.img--350

        .col-lg-8.mb-5.mb-lg-0
          .bloque-texto-a__texto.position-relative.p-4
            p.mb-0 Se ha hablado de la comunicación con el deudo, pero esta debe extenderse a lo largo de los procesos de interacción que se establecen con las personas del mismo sector funerario en torno al servicio fúnebre. El propósito de esta comunicación debe ser la asertividad como respuesta a un requerimiento, que despliega un conjunto de procesos a desarrollar por las personas de la empresa funeraria. #[strong.clr--green Para identificar más información sobre las cualidades de la comunicación asertiva revise el siguiente recurso educativo].    
